...
hittable_list myRTscape2() {
    ...
    // sun
    auto material7 = make_shared<diffuse_light>(color(2030,0,0));
    objects.add(make_shared<sphere>(point3(-22,15,-50), 5, material7));
    auto material8 = make_shared<dielectric>(20.0);
    objects.add(make_shared<sphere>(point3(-22,15,-50), 5.5, material8));
    ...
    //cube of cubes
    auto blue   = make_shared<lambertian>(color(.027, .15, .478));
    auto white   = make_shared<lambertian>(color(0.78,0.78,0.78));
    auto green   = make_shared<lambertian>(color(0,0.7,0));
    auto metalB   = make_shared<metal>(color(0.6,0.84,0.7), 0.1);
    ...
    shared_ptr<hittable> box5 = make_shared<box>(point3(1,0,1), point3(1.5,0.5,1.5), blue);
    box5 = make_shared<rotate_y>(box5, 11);
    box5 = make_shared<translate>(box5, vec3(1.5,1.6,1.3));
    objects.add(box5);


    shared_ptr<hittable> box4 = make_shared<box>(point3(1,0,1), point3(1.5,0.5,1.5), metalB);
    box4 = make_shared<rotate_y>(box4, -30);
    box4 = make_shared<translate>(box4, vec3(0.2,0,0.9));
    objects.add(box4);

    shared_ptr<hittable> box6 = make_shared<box>(point3(1,0,1), point3(1.5,0.5,1.5), metalB);
    box6 = make_shared<rotate_y>(box6, -30);
    box6 = make_shared<translate>(box6, vec3(-0.3,0,1.5));
    objects.add(box6);

    shared_ptr<hittable> box7 = make_shared<box>(point3(1,0,1), point3(1.5,0.5,1.5), metalB);
    box7 = make_shared<rotate_y>(box7, -30);
    box7 = make_shared<translate>(box7, vec3(0.2,0.6,0.9));
    objects.add(box7);

    shared_ptr<hittable> box8 = make_shared<box>(point3(1,0,1), point3(1.5,0.5,1.5), blue);
    box8 = make_shared<rotate_y>(box8, -30);
    box8 = make_shared<translate>(box8, vec3(-0.3,0.6,1.5));
    objects.add(box8);
